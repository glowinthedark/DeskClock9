...
import leg.behind.neck.deskclock.BaseActivity;
import leg.behind.neck.deskclock.DropShadowController;
import leg.behind.neck.deskclock.ItemAdapter;
import leg.behind.neck.deskclock.ItemAdapter.OnItemClickedListener;
import leg.behind.neck.deskclock.LogUtils;
import leg.behind.neck.deskclock.R;
import leg.behind.neck.deskclock.RingtonePreviewKlaxon;
import leg.behind.neck.deskclock.actionbarmenu.MenuItemControllerFactory;
import leg.behind.neck.deskclock.actionbarmenu.NavUpMenuItemController;
import leg.behind.neck.deskclock.actionbarmenu.OptionsMenuManager;
import leg.behind.neck.deskclock.alarms.AlarmUpdateHandler;
import leg.behind.neck.deskclock.data.DataModel;
import leg.behind.neck.deskclock.provider.Alarm;
...
import static leg.behind.neck.deskclock.ItemAdapter.ItemViewHolder.Factory;
import static leg.behind.neck.deskclock.ringtone.AddCustomRingtoneViewHolder.VIEW_TYPE_ADD_NEW;
import static leg.behind.neck.deskclock.ringtone.HeaderViewHolder.VIEW_TYPE_ITEM_HEADER;
import static leg.behind.neck.deskclock.ringtone.RingtoneViewHolder.VIEW_TYPE_CUSTOM_SOUND;
import static leg.behind.neck.deskclock.ringtone.RingtoneViewHolder.VIEW_TYPE_SYSTEM_SOUND;
