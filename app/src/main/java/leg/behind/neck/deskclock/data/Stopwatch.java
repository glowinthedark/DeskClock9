...
import static leg.behind.neck.deskclock.data.Stopwatch.State.PAUSED;
import static leg.behind.neck.deskclock.data.Stopwatch.State.RESET;
import static leg.behind.neck.deskclock.data.Stopwatch.State.RUNNING;
