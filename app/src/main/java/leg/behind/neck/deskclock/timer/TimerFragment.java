...
package leg.behind.neck.deskclock.timer;
...
import leg.behind.neck.deskclock.data.TimerListener;
import leg.behind.neck.deskclock.data.TimerStringFormatter;
...
public final class TimerFragment extends DeskClockFragment {
    ...
    private static final String EXTRA_TIMER_SETUP = "leg.behind.neck.deskclock.action.TIMER_SETUP";
