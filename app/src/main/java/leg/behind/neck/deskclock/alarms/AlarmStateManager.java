...
import leg.behind.neck.deskclock.AlarmClockFragment;
import leg.behind.neck.deskclock.AlarmUtils;
import leg.behind.neck.deskclock.AsyncHandler;
...
public final class AlarmStateManager extends BroadcastReceiver {
    ...
    public static final String ACTION_ALARM_CHANGED = "leg.behind.neck.deskclock.ALARM_CHANGED";
