...
import static leg.behind.neck.deskclock.Utils.now;
import static leg.behind.neck.deskclock.Utils.wallClock;
import static leg.behind.neck.deskclock.data.Timer.State.EXPIRED;
import static leg.behind.neck.deskclock.data.Timer.State.MISSED;
import static leg.behind.neck.deskclock.data.Timer.State.PAUSED;
import static leg.behind.neck.deskclock.data.Timer.State.RESET;
import static leg.behind.neck.deskclock.data.Timer.State.RUNNING;
