...
import leg.behind.neck.deskclock.widget.selector.AlarmSelection;
import leg.behind.neck.deskclock.widget.selector.AlarmSelectionAdapter;
...
public class AlarmSelectionActivity extends ListActivity {
    ...
    public static final String EXTRA_ACTION = "leg.behind.neck.deskclock.EXTRA_ACTION";
    public static final String EXTRA_ALARMS = "leg.behind.neck.deskclock.EXTRA_ALARMS";
