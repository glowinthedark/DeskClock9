...
package leg.behind.neck.deskclock.data;
...
import leg.behind.neck.deskclock.data.DataModel.AlarmVolumeButtonBehavior;
import leg.behind.neck.deskclock.data.DataModel.CitySort;
import leg.behind.neck.deskclock.data.DataModel.ClockStyle;
import leg.behind.neck.deskclock.settings.ScreensaverSettingsActivity;
import leg.behind.neck.deskclock.settings.SettingsActivity;
...
import static leg.behind.neck.deskclock.data.DataModel.AlarmVolumeButtonBehavior.DISMISS;
import static leg.behind.neck.deskclock.data.DataModel.AlarmVolumeButtonBehavior.NOTHING;
import static leg.behind.neck.deskclock.data.DataModel.AlarmVolumeButtonBehavior.SNOOZE;
import static leg.behind.neck.deskclock.data.Weekdays.Order.MON_TO_SUN;
import static leg.behind.neck.deskclock.data.Weekdays.Order.SAT_TO_FRI;
import static leg.behind.neck.deskclock.data.Weekdays.Order.SUN_TO_SAT;
...
final class SettingsDAO {
    ...
    public static final int SCREENSAVER_LANDSCAPE_DEFAULT_FONT_SIZE = 100;
    public static final int SCREENSAVER_PORTRAIT_DEFAULT_FONT_SIZE = 65;
