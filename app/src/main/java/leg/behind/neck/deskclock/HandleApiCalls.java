...
package leg.behind.neck.deskclock;
...
import leg.behind.neck.deskclock.alarms.AlarmStateManager;
import leg.behind.neck.deskclock.controller.Controller;
import leg.behind.neck.deskclock.data.DataModel;
import leg.behind.neck.deskclock.data.Timer;
import leg.behind.neck.deskclock.data.Weekdays;
...
import leg.behind.neck.deskclock.timer.TimerFragment;
import leg.behind.neck.deskclock.timer.TimerService;
...
import static leg.behind.neck.deskclock.AlarmSelectionActivity.ACTION_DISMISS;
import static leg.behind.neck.deskclock.AlarmSelectionActivity.EXTRA_ACTION;
import static leg.behind.neck.deskclock.AlarmSelectionActivity.EXTRA_ALARMS;
import static leg.behind.neck.deskclock.provider.AlarmInstance.FIRED_STATE;
import static leg.behind.neck.deskclock.provider.AlarmInstance.SNOOZE_STATE;
import static leg.behind.neck.deskclock.uidata.UiDataModel.Tab.ALARMS;
import static leg.behind.neck.deskclock.uidata.UiDataModel.Tab.TIMERS;
