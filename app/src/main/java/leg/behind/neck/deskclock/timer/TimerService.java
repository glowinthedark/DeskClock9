...
public final class TimerService extends Service {
    ...
    private static final String ACTION_PREFIX = "leg.behind.neck.deskclock.action.";
    ...
    public static final String EXTRA_TIMER_ID = "leg.behind.neck.deskclock.extra.TIMER_ID";
